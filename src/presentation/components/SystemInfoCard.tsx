...
export const SystemInfoCard: React.FC<SystemInfoProps> = ({ appInfo, systemInfo, loading }) => {
    return (
                    ...
                    <>
                        ...
                        {systemInfo && (
                            <Box>
                                ...
                                <Box display="flex" gap={1} flexWrap="wrap">
                                    <Chip
                                        label={`Node.js: ${systemInfo.nodeVersion}`}
                                        variant="outlined"
                                        size="small"
                                    />
                                    <Chip
                                        label={`Chrome: ${systemInfo.chromeVersion}`}
                                        variant="outlined"
                                        size="small"
                                    />
                                    <Chip
                                        label={`Electron: ${systemInfo.electronVersion}`}
                                        variant="outlined"
                                        size="small"
                                    />
                                </Box>

        ...
        <Container maxWidth="lg">
            <Box py={4}>
                ...
                <Typography variant="body1" color="text.secondary" paragraph>
                    This section handles file operations and device storage management for connected
                    Android devices.
                </Typography>
                ...
                <Paper elevation={1} sx={{ mb: 3 }}>
                    <Box p={3}>
                        ...
                        <Typography variant="body1" color="text.secondary" paragraph>
                            Monitor and manage storage usage across connected devices. View
                            available space and organize files efficiently.
                        </Typography>
                        ...
                        <Box mt={2}>
                            ...
                            <Typography variant="body2" color="text.secondary">
                                No devices currently connected. Connect an Android device to view
                                storage information.
                            </Typography>
                        </Box>
                    </Box>
